...
SELECT
  ...
  ad_group.demand_gen_ad_group_settings.channel_controls.selected_channels.youtube_in_feed AS cc_yt_infeed,
  ad_group.demand_gen_ad_group_settings.channel_controls.selected_channels.youtube_in_stream AS cc_yt_in_stream,
  ad_group.demand_gen_ad_group_settings.channel_controls.selected_channels.youtube_shorts AS cc_yt_shorts,
  ad_group.demand_gen_ad_group_settings.channel_controls.selected_channels.discover AS cc_discover,
  ad_group.demand_gen_ad_group_settings.channel_controls.selected_channels.display AS cc_display,
  ad_group.demand_gen_ad_group_settings.channel_controls.selected_channels.gmail AS cc_gmail,
